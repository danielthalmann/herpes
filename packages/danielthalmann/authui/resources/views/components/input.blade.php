...
<label class="mt-2" for="{{ $name }}id">
  ...
  <input type="{{ $type }}" name="{{ $name }}" value="{{ $value }}" id="{{ $name }}id"
    ...
    class="w-full px-4 py-2 border text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all">
</label>
