...
<div class={cn(
    ...
    <div class="relative">
        ...
        <button onclick={() => {draweropened = !draweropened}}
            class={cn(
                "px-4 py-2 border bg-white dark:bg-gray-800 border-gray-500 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all pr-9 cursor-pointer",
                className,
            )}>
            {optionLabel ? optionLabel : placeholder}&nbsp;
