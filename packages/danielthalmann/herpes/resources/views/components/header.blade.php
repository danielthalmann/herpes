...
@php
    ...
    $inactif = ' class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white" ';
@endphp
<div class="min-h-full">
  <nav class="bg-gray-800/90">
        ...
        <div class="hidden md:block">
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <div x-data="{open : false}" class="relative ml-3">
              ...
              <div x-show="open" x-transition class="absolute top-10 right-0 w-48 rounded-md bg-gray-800 py-1 outline-1 -outline-offset-1 outline-white/10 transition transition-discrete">
    ...
    <div id="mobile-menu" hidden class="block md:hidden">
